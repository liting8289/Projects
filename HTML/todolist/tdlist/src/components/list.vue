...
<div>
        <div class="table">
            <!-- 勾勾 -->
                <!-- <input type="checkbox"  v-if="item.act=='y'" checked="checked " >
                <input type="checkbox" v-else-if="item.act=='n'" @click="finItem(item.id)  ,isfin=!isfin" -->
                ...
                <!-- <label> -->
                    ...
                    <!-- <a v-else-if="!this.isEdit && !this.isfin">{{item.work}}</a> -->
                    <!-- <a v-if="!this.isEdit" class="completed">{{item.work}}</a>
